...
% [n, dataset_size; rmse_test; edot_test; mean(dtwd_test); std(dtwd_test);
...
rmse_train = graph_data(7,:);
edot_train = graph_data(8,:);
mean_dtwd_train = graph_data(9,:);
std_dtwd_train = graph_data(10,:);
